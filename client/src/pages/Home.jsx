...
// import { LogIn, UserPlus, BookOpen, PenTool, Layers, CheckCircle2 } from "lucide-react";
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-600 to-fuchsia-500 overflow-y-auto relative">

//       <div className="absolute top-20 left-10 w-48 h-48 bg-white/20 rounded-full blur-3xl"></div>
//       <div className="absolute bottom-20 right-10 w-56 h-56 bg-indigo-400/30 rounded-full blur-3xl"></div>

//       <header className="backdrop-blur-xl bg-white/20 border-b border-white/30 shadow-lg sticky top-0 z-50">
//         <div className="max-w-6xl mx-auto flex items-center justify-between py-4 px-6">
//           <h1 className="text-2xl font-extrabold bg-gradient-to-r from-white to-purple-200 text-transparent bg-clip-text drop-shadow">
//             Digital Ebook Studio
//           </h1>

//           <nav className="flex gap-3">
//             <Link to="/login" className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/30 backdrop-blur-md text-white hover:bg-white/40 transition font-medium shadow">
//               <LogIn size={18} /> Login
//             </Link>
//             <Link to="/register" className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 transition text-white font-medium shadow-lg">
...
//       <main className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
//         <motion.div initial="hidden" animate="show" variants={fadeUp} className="text-white space-y-5">
//           <h2 className="text-4xl md:text-5xl font-extrabold leading-tight drop-shadow">
//             Create Beautiful eBooks
//             <span className="block text-indigo-200">with Zero Hassle</span>
//           </h2>

//           <p className="text-white/90 text-lg">
//             Write, edit, and design your ebooks online.
//             Save drafts, add cover pages, and request admin approval — all in one place.
//           </p>

//           <Link to="/register" className="inline-flex items-center gap-2 mt-2 px-6 py-3 text-lg bg-gradient-to-r from-indigo-600 to-pink-500 text-white rounded-xl shadow-lg hover:scale-105 transition font-semibold">
//             <BookOpen size={20} /> Start Creating
//           </Link>
//         </motion.div>

//         <motion.div initial="hidden" animate="show" variants={fadeUp} className="bg-white/80 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-6">
//           <h3 className="text-xl font-semibold text-purple-700 mb-3">Live Editor Preview</h3>
//           <div className="h-60 overflow-y-auto p-4 rounded-lg bg-gradient-to-b from-white/50 to-white/80 border border-white/40 shadow-inner space-y-2 text-gray-700 text-sm">
//             <p>✍️ Rich text editor</p>
//             <p>📎 Cover & media uploads</p>
//             <p>📂 Auto-save & drafts</p>
//             <p>✅ Admin review system</p>
//             <p>📄 Page management</p>
//             <p>📥 Download PDF version</p>
//             <p>🎨 Theme-based preview</p>
//           </div>
//         </motion.div>
//       </main>

//       <section className="max-w-6xl mx-auto px-6 py-12 space-y-10">
//         <motion.h2 initial="hidden" animate="show" variants={fadeUp} className="text-3xl font-bold text-white text-center drop-shadow">
//           Why Choose Our Studio?
//         </motion.h2>

//         <div className="grid md:grid-cols-3 gap-6">
//           {[
//             { icon: PenTool, title: "Easy Writing", desc: "Minimal distraction writing space with auto-save." },
//             { icon: Layers, title: "Design Covers", desc: "Upload images & choose fonts for stunning covers." },
//             { icon: CheckCircle2, title: "Publishing Workflow", desc: "Admin reviews help ensure book quality." }
//           ].map((f, i) => (
//             <motion.div key={i} initial="hidden" animate="show" variants={{ ...fadeUp, transition: { duration: 0.6, delay: i * 0.1 } }} className="bg-white/20 border border-white/30 backdrop-blur-lg p-6 rounded-xl shadow-lg text-white text-center space-y-3">
//               <f.icon size={36} className="mx-auto" />
...
//       <section className="bg-white/10 backdrop-blur-xl border-t border-white/20 py-12">
//         <div className="max-w-6xl mx-auto px-6">
//           <h2 className="text-white text-2xl font-bold mb-6">What creators say</h2>
//           <div className="grid md:grid-cols-2 gap-6">
//             {[
//               `"Best ebook creator I’ve used — UI is magical!"`,
//               `"The admin approval flow helped me publish confidently!"`,
//             ].map((t, i) => (
//               <motion.div key={i} initial="hidden" animate="show" variants={fadeUp} className="p-5 rounded-xl bg-white/20 border border-white/30 text-white text-sm shadow">
//                 ★★★★☆ — {t}
//               </motion.div>
//             ))}
//           </div>
...
//         <motion.h2 initial="hidden" animate="show" variants={fadeUp} className="text-3xl font-bold text-center mb-6">Our Mission</motion.h2>
//         <motion.p initial="hidden" animate="show" variants={fadeUp} className="text-center text-white/90 max-w-3xl mx-auto text-lg">
//           We believe every storyteller deserves a beautiful space to bring words to life — without the need for expensive software or complex publishing platforms.
//         </motion.p>
//       </section>

//       <section className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-6 gap-y-6 text-center text-white">
//         {[
//           { num: "3,200+", label: "ebooks drafted" },
//           { num: "950+", label: "published authors" },
//           { num: "120+", label: "design templates" },
//           { num: "40+", label: "countries using platform" },
//         ].map((s, i) => (
//           <motion.div key={i} initial="hidden" animate="show" variants={{ ...fadeUp, transition: { delay: i * 0.1 } }} className="p-6 bg-white/15 border border-white/20 rounded-xl backdrop-blur-lg shadow-lg">
...
//       <section className="max-w-5xl mx-auto px-6 py-14 text-center text-white">
//         <h2 className="text-3xl font-bold mb-6">Sneak Peek of Editor</h2>
//         <video className="w-full rounded-xl border border-white/30 shadow-lg" src="" poster="https://via.placeholder.com/900x450?text=Editor+Demo+Coming+Soon" controls></video>
//         <p className="text-sm text-white/70 mt-2">Short demo video coming soon</p>
//       </section>

//       <section className="max-w-6xl mx-auto px-6 py-14">
//         <h2 className="text-3xl font-bold text-white text-center mb-8">More Author Stories</h2>
//         <div className="grid md:grid-cols-3 gap-6">
//           {[
//             `"I published my first children's book here — so smooth!"`,
//             `"Finally, a creator tool that doesn’t overwhelm."`,
//             `"The UI is stunning and workflow is simple — love it!"`
//           ].map((t, i) => (
//             <motion.div key={i} initial="hidden" animate="show" variants={{ ...fadeUp, transition: { delay: i * 0.1 } }} className="p-5 bg-white/20 text-white rounded-xl border border-white/25 backdrop-blur-md shadow">
//               ⭐⭐⭐⭐⭐
...
//       <section className="text-center py-12 bg-gradient-to-r from-indigo-600/80 to-pink-500/80 backdrop-blur-xl border-t border-white/20">
//         <h2 className="text-3xl font-bold text-white mb-3">Ready to publish your story?</h2>
//         <p className="text-white/90 mb-6">Join creators around the world sharing their imagination.</p>
//         <Link to="/register" className="px-6 py-3 text-lg bg-white text-purple-700 rounded-xl shadow-lg hover:scale-105 transition font-semibold">Start for Free</Link>
//       </section>

//       <footer className="text-center text-white/80 text-sm py-6">© {new Date().getFullYear()} Digital Ebook Studio · Made with 💜</footer>
//     </div>
//   );
// }
import React from "react";
